...
export function maybeShowSafetyNotice() {
  ...
  overlay.innerHTML = `
    <div class="safety-card" role="dialog" aria-modal="true" aria-labelledby="safety-title">
      ...
      <p>Slackwater shows tide <strong>predictions</strong> and weather from the NOAA station network, for general information and recreation. Data can be delayed, estimated, or wrong, and real conditions can differ.</p>
